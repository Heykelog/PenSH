...
class PentestReportGenerator:
    def __init__(self, theme: str = "emerald"):
        self.styles = getSampleStyleSheet()
        self.report = None  # Store report for header access
        self.theme_name = (theme or "emerald").lower()
    ...
    def setup_custom_styles(self):
        ...
        palette = palettes.get(self.theme_name, palettes["emerald"])

        self.primary_color = colors.HexColor(palette["primary"])
        self.secondary_color = colors.HexColor(palette["secondary"])
        self.accent_color = colors.HexColor(palette["accent"])
        self.success_color = colors.HexColor(palette["success"])
        self.warning_color = colors.HexColor(palette["warning"])
        self.info_color = colors.HexColor(palette["info"])
        self.light_gray = colors.HexColor('#f5f5f5')        # Light gray
        self.dark_gray = colors.HexColor('#424242')         # Dark gray
        self.bank_blue = colors.HexColor(palette["bank_blue"])
        self.bank_gold = colors.HexColor(palette["bank_gold"])
